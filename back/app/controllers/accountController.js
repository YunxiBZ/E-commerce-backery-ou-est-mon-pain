  ...
  handleLoginForm: async (req, res) => {
    try {
      ...
      if (account) {
        ...
        const jwtOptions = {
          algorithm: 'HS256', // HS256 est un algorithme de chiffrement robuste
          expiresIn: '3h',
        };
        // process.env.SECRET SECRET Il faut minmun 100 caractère
        const token = jwt.sign(jwtContent, process.env.TOKEN_KEY, jwtOptions);
